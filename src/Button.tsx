      ...
      return css([
        {
          ...
          backgroundImage: gradient(
            ...
            color(theme.colors.intent.primary.base).lighten(0.4).toString()
          ),
          boxShadow: dark
            ? insetShadow(
      ...
      return css([
        {
          ...
          backgroundImage: gradient(
            ...
            color(theme.colors.intent.success.base).lighten(0.5).toString()
          ),
          boxShadow: dark
            ? insetShadow(
                theme.colors.palette.gray.dark,
          ...
          '&[aria-expanded="true"]': {
            boxShadow: activeShadow,
            backgroundImage: gradient(
              color(theme.colors.intent.success.base).darken(0.2).toString(),
              theme.colors.intent.success.base
            ),
          },
        },
      ...
      return css([
        {
          ...
          backgroundImage: gradient(
            ...
            color(theme.colors.intent.danger.base).lighten(0.3).toString()
          ),
          boxShadow: dark
            ? insetShadow(
                theme.colors.palette.gray.dark,
          ...
          '&[aria-expanded="true"]': {
            boxShadow: activeShadow,
            backgroundImage: gradient(
              color(theme.colors.intent.danger.base).darken(0.2).toString(),
              theme.colors.intent.danger.base
            ),
          },
        },
      ...
      return css([
        {
          ...
          backgroundImage: gradient(
            ...
            color(theme.colors.intent.warning.base).lighten(0.4).toString()
          ),
          boxShadow: dark
            ? insetShadow(
                theme.colors.palette.gray.dark,
          ...
          '&[aria-expanded="true"]': {
            boxShadow: activeShadow,
            backgroundImage: gradient(
              color(theme.colors.intent.warning.base).darken(0.2).toString(),
              theme.colors.intent.warning.base
            ),
          },
        },
...
export type ButtonIntent = 'none' | 'warning' | 'primary' | 'success' | 'danger'
...
const ghostIntents = (
  ...
  let base = none ? theme.colors.text.default : theme.colors.intent[intent].base
